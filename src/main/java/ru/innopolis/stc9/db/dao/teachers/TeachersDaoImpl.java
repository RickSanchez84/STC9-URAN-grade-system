...
public class TeachersDaoImpl implements TeachersDao {
    ...
    public void update(Teacher teacher) throws SQLException {
        logger.info("Class SheduleDaoImpl method update started, id = " + teacher.getId());

        String sql = "UPDATE teacher_facilities SET teacher_facilities = ?, subject_item = ? WHERE id = "+teacher.getId()+"";

        execureStatement(teacher, sql);
        logger.info("Class SheduleDaoImpl method update finished, id = " + teacher.getId());
    }
