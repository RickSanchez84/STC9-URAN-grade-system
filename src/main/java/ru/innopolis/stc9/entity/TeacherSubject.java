...
public class TeacherSubject {
    ...
    @Id
    @SequenceGenerator(name = "teacherSubjectSeq", sequenceName = "TeacherSubject_SEQUENCE", allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "teacherSubjectSeq")
    public long getId() {
        return id;
    }
